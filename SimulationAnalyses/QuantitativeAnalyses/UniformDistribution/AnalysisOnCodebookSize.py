...
for k in range(repeat_times):
    ...
    for i in range(len(codebook_size_list)):
        ...
        for width in variance_list:
            ...
            print("codebook size: "+str(codebook_size)+"  width: "+str(width)+"  Quantization Error: "+str(avg_nearest_distance)+"  codebook_utilization: "+str(codebook_utilization)+"   perplexity: "+str(perplexity))
...
################################################################ Save as .pkl format ################################################################
with open('Data_pkl/Uniform_CodebookSize.pkl', 'wb') as f:

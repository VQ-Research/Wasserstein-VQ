...
for k in range(repeat_times):
    ...
    for i in range(len(embed_dim_list)):
        ...
        for variance in variance_list:
            ...
            print("feature dim: "+str(embed_dim)+"  variance: "+str(variance)+"  Quantization Error: "+str(avg_nearest_distance)+"  codebook_utilization: "+str(codebook_utilization)+"   perplexity: "+str(perplexity))
...
with open('Data_pkl/Gaussian_FeatureDim.pkl', 'wb') as f:

...
feature = torch.randn(feature_size, embed_dim, device=device)
...
################################ analysis the influence of Codebook when mean changes ################################
repeat_times = 5
...
for k in range(repeat_times):
    ...
    for i in range(len(codebook_size_list)):
        ...
        for mean in mean_list:
            ...
            print("Codebook size: "+str(codebook_size)+"  Mean: "+str(mean)+"  Quantization Error: "+str(avg_nearest_distance)+"  Codebook Utilization: "+str(codebook_utilization)+"   Perplexity: "+str(perplexity))
...
################################ analysis the influence of Codebook when variance changes ################################
total_wasserstein_distance_list = []
total_codebook_utilization_list = []
total_perplexity_list = []
total_distance_list = []
...
for k in range(repeat_times):
    ...
    for i in range(len(codebook_size_list)):
        ...
        for variance in variance_list:
            ...
            print("codebook size: "+str(codebook_size)+"  Variance: "+str(variance)+"  Quantization Error: "+str(avg_nearest_distance)+"  codebook_utilization: "+str(codebook_utilization)+"   perplexity: "+str(perplexity))
...
################################################################ Save as .pkl format ################################################################
with open('Experiment_Data/pkl/Gaussian_CodebookSize.pkl', 'wb') as f:

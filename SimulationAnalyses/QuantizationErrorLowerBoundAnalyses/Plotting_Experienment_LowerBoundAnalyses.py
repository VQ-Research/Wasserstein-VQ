...
mean_list_U = [2.5, 2.0, 1.5, 1.0, 0.5, 0.0]
width_list = [6.0, 5.0, 4.0, 3.0, 2.0, 1.0]
...
def Calculate_and_Draw(total_list = None, Y_Name = None, X_Name = None, LOG = False, save_path = None):
    ...
    plt.tight_layout()
    plt.savefig(f'FIG/{save_path}.pdf')
    plt.clf()
...
def Calculate_and_Draw_Unif(total_list = None, Y_Name = None, X_Name = None, LOG = False, save_path = None):
    total_list = np.array(total_list)
    if LOG == True:
        total_list = np.log10(total_list)
...
# For Lower bound
with open('Data_pkl/lower_bound_Gaussian_CodebookSize.pkl', 'rb') as f:
    lists = pickle.load(f)
list1, list2, list3, list4, list5, list6, list7, list8 = lists
disntance_list = Calculate_and_Draw(total_list = list4, Y_Name = 'Quantization Error', X_Name = 'Mean', LOG=True, save_path='lower_bound_CodebookSize_mean_Quant')
disntance_list = Calculate_and_Draw(total_list = list8, Y_Name = 'Quantization Error', X_Name = 'Variance', LOG=True, save_path='lower_bound_CodebookSize_Var_Quant')


name = 'FeatureDim'
with open('Data_pkl/lower_bound_Gaussian_FeatureDim.pkl', 'rb') as f:
    lists = pickle.load(f)
list1, list2, list3, list4, list5, list6, list7, list8 = lists
disntance_list = Calculate_and_Draw(total_list = list4, Y_Name = 'Quantization Error', X_Name = 'Mean', LOG=True, save_path=f'lower_bound_{name}_mean_Quant')
disntance_list = Calculate_and_Draw(total_list = list8, Y_Name = 'Quantization Error', X_Name = 'Variance', LOG=True, save_path=f'lower_bound_{name}_Var_Quant')


name = 'FeatureSize'
with open('Data_pkl/lower_bound_Gaussian_FeatureSize.pkl', 'rb') as f:
    lists = pickle.load(f)
list1, list2, list3, list4, list5, list6, list7, list8 = lists
disntance_list = Calculate_and_Draw(total_list = list4, Y_Name = 'Quantization Error', X_Name = 'Mean', LOG=True, save_path=f'lower_bound_{name}_mean_Quant')
disntance_list = Calculate_and_Draw(total_list = list8, Y_Name = 'Quantization Error', X_Name = 'Variance', LOG=True, save_path=f'lower_bound_{name}_Var_Quant')
...
name = 'Uniform_CodebookSize'
with open('Data_pkl/lower_bound_Uniform_CodebookSize.pkl', 'rb') as f:
    lists = pickle.load(f)
list1, list2, list3, list4, list5, list6, list7, list8 = lists
disntance_list = Calculate_and_Draw_Unif(total_list = list4, Y_Name = 'Quantization Error', X_Name = 'Mean', LOG=True, save_path=f'lower_bound_{name}_mean_Quant')
disntance_list = Calculate_and_Draw_Unif(total_list = list8, Y_Name = 'Quantization Error', X_Name = 'Variance', LOG=True, save_path=f'lower_bound_{name}_Var_Quant')


name = 'Uniform_FeatureDim'
with open('Data_pkl/lower_bound_Uniform_FeatureDim.pkl', 'rb') as f:
    lists = pickle.load(f)
list1, list2, list3, list4, list5, list6, list7, list8 = lists
disntance_list = Calculate_and_Draw_Unif(total_list = list4, Y_Name = 'Quantization Error', X_Name = 'Mean', LOG=True, save_path=f'lower_bound_{name}_mean_Quant')
disntance_list = Calculate_and_Draw_Unif(total_list = list8, Y_Name = 'Quantization Error', X_Name = 'Variance', LOG=True, save_path=f'lower_bound_{name}_Var_Quant')
...
name = 'Uniform_FeatureSize'
with open('Data_pkl/lower_bound_Uniform_FeatureSize.pkl', 'rb') as f:
    lists = pickle.load(f)
list1, list2, list3, list4, list5, list6, list7, list8 = lists
disntance_list = Calculate_and_Draw_Unif(total_list = list4, Y_Name = 'Quantization Error', X_Name = 'Mean', LOG=True, save_path=f'lower_bound_{name}_mean_Quant')
disntance_list = Calculate_and_Draw_Unif(total_list = list8, Y_Name = 'Quantization Error', X_Name = 'Variance', LOG=True, save_path=f'lower_bound_{name}_Var_Quant')

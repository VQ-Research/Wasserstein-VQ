...
for k in range(repeat_times):
    ...
    for i in range(len(embed_dim_list)):
        ...
        for mean in mean_list:
            ...
            print("feature dim: "+str(embed_dim)+"  mean: "+str(mean)+"  wasserstein_distance: "+str(wasserstein_distance)+"  codebook_utilization: "+str(codebook_utilization)+"   perplexity: "+str(perplexity))
...
for k in range(repeat_times):
    ...
    for i in range(len(embed_dim_list)):
        ...
        for variance in variance_list:
            ...
            print("feature dim: "+str(embed_dim)+"  variance: "+str(variance)+"  wasserstein_distance: "+str(wasserstein_distance)+"  codebook_utilization: "+str(codebook_utilization)+"   perplexity: "+str(perplexity))
...
with open('Data_pkl/lower_bound_Gaussian_FeatureDim.pkl', 'wb') as f:

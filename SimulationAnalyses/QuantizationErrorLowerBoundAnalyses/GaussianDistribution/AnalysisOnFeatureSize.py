...
for k in range(repeat_times):
    ...
    for i in range(len(feature_size_list)):
        ...
        for mean in mean_list:
            ...
            print("feature size: "+str(feature_size)+"  mean: "+str(mean)+"  wasserstein_distance: "+str(wasserstein_distance)+"  codebook_utilization: "+str(codebook_utilization)+"   perplexity: "+str(perplexity))
...
for k in range(repeat_times):
    ...
    for i in range(len(feature_size_list)):
        ...
        for variance in variance_list:
            ...
            print("feature size: "+str(feature_size)+"  variance: "+str(variance)+"  wasserstein_distance: "+str(wasserstein_distance)+"  codebook_utilization: "+str(codebook_utilization)+"   perplexity: "+str(perplexity))
...
with open('Data_pkl/lower_bound_Gaussian_FeatureSize.pkl', 'wb') as f:

...
for k in range(repeat_times):
    ...
    for i in range(len(embed_dim_list)):
        ...
        for width in variance_list:
            ...
            print("feature dim: "+str(embed_dim)+"  width: "+str(width)+"  wasserstein_distance: "+str(wasserstein_distance)+"  codebook_utilization: "+str(codebook_utilization)+"   perplexity: "+str(perplexity))
...
with open('Data_pkl/lower_bound_Uniform_FeatureDim.pkl', 'wb') as f:

...
for k in range(repeat_times):
    ...
    for i in range(len(feature_size_list)):
        ...
        for width in variance_list:
            ...
            print("feature size: "+str(feature_size)+"  width: "+str(width)+"  wasserstein_distance: "+str(wasserstein_distance)+"  codebook_utilization: "+str(codebook_utilization)+"   perplexity: "+str(perplexity))
...
with open('Data_pkl/lower_bound_Uniform_FeatureSize.pkl', 'wb') as f:

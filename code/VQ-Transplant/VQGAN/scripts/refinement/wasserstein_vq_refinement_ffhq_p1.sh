...
CUDA_VISIBLE_DEVICES="0,1" python -m torch.distributed.launch --nproc_per_node=2 --master_port=12881 train_VQ_refinement.py --VQ=wasserstein_vq --dataset_name=FFHQ --global_batch_size=64 --codebook_size=16384  --codebook_dim=16 --stage=refinement --refinement_epochs=50 --alpha=1.0 --beta=0.2 --gamma=1.0 --disc_weight=0.4 --checkpoint_name checkpoint-wasserstein_vq_transplant_False_FFHQ_model_16384_16_loss_1.0_0.2_1.0_0.4-50.pth.tar
